...
export const EmployeeForm: React.FC<EmployeeFormProps> = ({
  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        designation: initialData.profile?.designation || initialData.designation || 'Technician',
        basicSalary: initialData.profile?.basicSalary || initialData.basicSalary || 65000,
      ...
      if (initialData.employeeId) {
        setNextUserId(initialData.employeeId);
      }
    }
  }, [initialData]);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 text-xs font-medium">
      ...
      {/* Photo */}
      <div>
        <label className="block text-slate-700 mb-1 font-bold">Photo</label>
        <input
          type="file"
          accept="image/*"

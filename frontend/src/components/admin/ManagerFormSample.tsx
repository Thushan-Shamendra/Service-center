...
interface ManagerFormSampleProps {
  onSubmit: (formData: FormData) => Promise<void>;
  onCancel: () => void;
  initialData?: any;
}

export const ManagerFormSample: React.FC<ManagerFormSampleProps> = ({
  onSubmit,
  onCancel,
  initialData,
}) => {
  const [formData, setFormData] = useState({
    ...
    address: {
      street: '45 Queen Street, Colombo 03',
      city: 'Colombo',
      province: 'Western',
      postalCode: '00300',
    },
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 text-xs font-medium">
      ...
      <div className="bg-slate-50 p-3 rounded-xl border border-slate-200">
        <label className="block text-slate-500 mb-1">Manager ID *</label>

...
import { ArrowLeft, CreditCard, Check, Clock, DollarSign, Download, Printer } from 'lucide-react';

export const InvoiceReportsPage: React.FC = () => {
  ...
  const reportTypes = [
    {
      id: 'paid-invoices',
      title: 'Paid Invoices',
      description: 'Fully paid invoices and payment history',
      icon: Check,
      color: 'bg-emerald-50 text-emerald-600',
      path: '/manager/reports/invoices/paid'
    },
    {
      id: 'unpaid-invoices',
      title: 'Unpaid Invoices',
      description: 'Outstanding unpaid invoices',
      icon: Clock,
      color: 'bg-rose-50 text-rose-600',
      path: '/manager/reports/invoices/unpaid'
    },
    {
      id: 'partially-paid',
      ...
      path: '/manager/reports/invoices/partial'
    },
    {
      id: 'daily-sales',
      title: 'Daily Sales Summary',
      description: 'Daily sales trends and revenue',
      icon: DollarSign,
      color: 'bg-blue-50 text-blue-600',
      path: '/manager/reports/invoices/daily-sales'
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-2xl font-bold text-slate-900">💳 Invoice Reports</h1>
